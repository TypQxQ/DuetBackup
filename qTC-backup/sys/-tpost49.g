...
G53 G0 X500	Y515 F40000       		; Rapid to the approach position with tool-0. (park_x, park_y - offset).  Y next to make a square move. 
G53 G0 X590 F40000       			; Fast Move to the pickup position with tool.
G53 G0 X598 F6000        			; Slow Move to the pickup position with tool-0.

	;Lock the tool
M98 P"/sys/custom/tool_lock.g" 		; Lock the tool

; Move nozzle to purge area
G53 G0 X580 F6000       			; Wipe Backwards, and move away from other tools, incase next move is X only. 
