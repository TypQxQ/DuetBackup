...
M584 X0 Y6 Z1:9:2 E5 U4 V8 R0 S0 P5 ; 1=LeftZ(marked Y on Duet) 9=RearZ (Last on Duex), 2=RightZ (marked Z on Duet), 0=marked X, 3=marked E0, 4=marked E1
...
;M350 X32 Y32 U32 V32 W32 A32 Z32 E32 I0          ; Configure microstepping without interpolation
;M350 X32 Y32 U32 V32 Z32 E32 I0          ; Configure microstepping without interpolation
M350 Z32 E32 I0          ; Configure microstepping without interpolation
M350 X16 Y16 U16 V16 I1          ; Configure microstepping without interpolation
...
M92 X79.907 Y80.028 U79.907 V80.028 Z1600 E564.375 S16
